	...
	public List<ChiTietHoaDon> getCT_HoaDon(String mahd) {
	    ...
	    try {
	        ...
	        String sql = "SELECT SanPham.Tensp, SanPham.Size, SanPham.MauSac, ChatLieu.TenChatLieu, " +
	            "SanPham.GiaBan, CT_HoaDon.SoLuongSP, ISNULL(SanPham.VAT, 0) as VAT, ISNULL(KhuyenMai.PhanTramKhuyenMai, 0) as KhuyenMai, (SanPham.GiaBan * CT_HoaDon.SoLuongSP) as ThanhTien " +
	            "FROM CT_HoaDon " +
